...
urlpatterns = [
    ...
    path('about/', portfolio_views.about_organization, name='about_organization'),
    ...
    path('manager/contact-requests/', portfolio_views.manager_contact_requests, name='manager_contact_requests'),
    path('manager/contact-requests/<int:request_id>/approve/', portfolio_views.manager_approve_contact_request, name='manager_approve_contact_request'),
    path('manager/contact-requests/<int:request_id>/reject/', portfolio_views.manager_reject_contact_request, name='manager_reject_contact_request'),
    path('manager/student-applications/', portfolio_views.manager_student_applications, name='manager_student_applications'),
    path('manager/student-applications/<int:application_id>/', portfolio_views.manager_application_detail, name='manager_application_detail'),
    ...
    path('delete-project/<int:project_id>/', portfolio_views.delete_project, name='delete_project'),
    ...
    path('manager/students/<int:student_id>/edit/', portfolio_views.manager_edit_student, name='manager_edit_student'),
    ...
    path('manager/groups/', portfolio_views.manager_groups, name='manager_groups'),
    path('manager/groups/create/', portfolio_views.group_create, name='group_create'),
    path('manager/groups/<int:group_id>/edit/', portfolio_views.group_edit, name='group_edit'),
    path('manager/groups/<int:group_id>/delete/', portfolio_views.group_delete, name='group_delete'),
